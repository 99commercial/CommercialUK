...
const PAGE_PATH = '/CommercialUK-vs-Zoopla-Commercial';
const CANONICAL_URL = `${SITE_URL}${PAGE_PATH}`;

export const METADATA = {
  title: 'CommercialUK vs Zoopla Commercial | Compare UK Portals',
  description:
    'Compare CommercialUK with Zoopla Commercial. £25 PCM, unlimited valuations, zero commission, full listing control. UK commercial property for landlords and sellers.',
  keywords: [
    'commercial property portal UK',
    'CommercialUK vs Zoopla',
    'Zoopla commercial',
  ...
  twitter: {
    ...
    title: 'CommercialUK vs Zoopla Commercial | Compare UK Portals',
    description:
      'Compare CommercialUK with Zoopla Commercial. £25 PCM, unlimited valuations, zero commission, full listing control.',
  },
  robots: 'index, follow',
...
const zooplaRows: Array<{
  ...
  { feature: 'Monthly Listing Fee', cuLabel: '£25 PCM (discounted)', cuPill: null, otherLabel: 'Typically much higher — agent advertising packages often start from £150+ PCM (and can vary)', otherPill: 'no' },
  { feature: 'Commission', cuLabel: 'Zero', cuPill: 'yes', otherLabel: 'Zero', otherPill: 'yes' },
  { feature: 'Free Valuations Included', cuLabel: 'Unlimited commercial property valuations', cuPill: 'yes', otherLabel: 'Not included', otherPill: 'no' },
  { feature: 'Listing Control', cuLabel: 'Full direct control by Agents/landlord/seller', cuPill: 'yes', otherLabel: 'Listings usually via estate agents', otherPill: 'no' },
  { feature: 'Direct Enquiries to Owner', cuLabel: 'Yes', cuPill: 'yes', otherLabel: 'Yes', otherPill: 'yes' },
  { feature: 'UK Market Focus', cuLabel: 'Specifically UK commercial property', cuPill: 'yes', otherLabel: 'UK portal with residential + commercial reach', otherPill: 'yes' },
  { feature: 'Exposure & Traffic', cuLabel: 'Targeted UK audience', cuPill: null, otherLabel: 'Very large general audience as part of major property portal', otherPill: null },
  { feature: 'GDPR & Compliance', cuLabel: 'Fully UK GDPR compliant', cuPill: 'yes', otherLabel: 'GDPR compliant', otherPill: 'yes' },
  { feature: 'Featured Tools & Insights', cuLabel: 'Dedicated landlord-friendly platform', cuPill: 'yes', otherLabel: 'Additional tools such as commercial price insights and mortgage calculators', otherPill: 'yes' },
];

export default function CommercialUKVsZooplaPage() {
  return (
      ...
      <header role="banner">
        <HeroRoot>
          ...
          <HeroInner>
            ...
            >
              Compare UK commercial property platforms. See how CommercialUK offers affordable listing, full control, and free valuations versus Zoopla Commercial.
            </Typography>
          </HeroInner>
          <HeroBar />
        </HeroRoot>
          ...
          <Container maxWidth="lg">
            <section aria-labelledby="page-intro">
              ...
              >
                ...
                {' '}with Zoopla Commercial on pricing, features, UK market focus, and compliance so you can decide which platform fits your commercial listings best.
              </Typography>
            </section>
            <section aria-labelledby="comparison-zoopla">
            <SectionBlock>
              ...
              >
                CommercialUK vs <Box component="span" sx={{ color: colors.yellowDark }}>Zoopla Commercial</Box>
              </Typography>
              ...
              >
                <Table sx={{ tableLayout: 'fixed', width: '100%' }} aria-label="CommercialUK vs Zoopla Commercial comparison">
                  <TableHead>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, margin: 2 }}>
                <Box sx={{ borderRadius: '10px', border: `1px solid ${colors.border}`, p: 3, background: colors.white }}>
                  ...
                  <Typography sx={{ fontSize: 16, color: colors.gray700, lineHeight: 1.7, mb: 2 }}>
                    CommercialUK offers a simple, transparent monthly cost that&apos;s highly affordable — ideal for private landlords and sellers who want professional exposure without high portal fees.
                  </Typography>
                  <Typography sx={{ fontSize: 16, color: colors.gray700, lineHeight: 1.7 }}>
                    Zoopla Commercial campaigns are typically part of wider agent advertising packages, which tend to be significantly more expensive and negotiated through a third-party agent rather than listed directly by the owner.
                  </Typography>
                </Box>
                <Box sx={{ borderRadius: '10px', border: `1px solid ${colors.border}`, p: 3, background: colors.white }}>
                  <Typography sx={{ fontFamily: '"Montserrat", sans-serif', fontWeight: 700, fontSize: 15, color: colors.yellowDark, mb: 1.5 }}>Exposure</Typography>
                  <Typography sx={{ fontSize: 16, color: colors.gray700, lineHeight: 1.7, mb: 2 }}>
                    Zoopla sits among the UK&apos;s most recognised property portals with very high overall traffic, including both residential and commercial audiences.
                  </Typography>
                  <Typography sx={{ fontSize: 16, color: colors.gray700, lineHeight: 1.7 }}>
                    CommercialUK, while niche, focuses purely on commercial property — meaning more relevant leads for landlords and sellers without being lost among residential listings.
                  </Typography>
                </Box>
                <Box sx={{ borderRadius: '10px', border: `1px solid ${colors.border}`, p: 3, background: colors.white }}>
                  <Typography sx={{ fontFamily: '"Montserrat", sans-serif', fontWeight: 700, fontSize: 15, color: colors.yellowDark, mb: 1.5 }}>Tools & Features</Typography>
                  <Typography sx={{ fontSize: 16, color: colors.gray700, lineHeight: 1.7, mb: 2 }}>
                    Zoopla has built-in commercial property tools (e.g., commercial mortgage calculator, pricing insights), helping buyers and investors make informed decisions.
                  </Typography>
                  <Typography sx={{ fontSize: 16, color: colors.gray700, lineHeight: 1.7 }}>
                    CommercialUK emphasises landlord control, simplicity, and cost effectiveness — ideal if you want fewer barriers and more direct engagement with prospects.
                  </Typography>
                </Box>
              </Box>
            </SectionBlock>
              ...
              <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: 3, mt: 1 }}>
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 3, fontFamily: '"Montserrat", sans-serif', fontWeight: 800, fontSize: 15, letterSpacing: '0.06em', textTransform: 'uppercase', color: colors.black }}>
                    ...
                    Choose Zoopla Commercial if you want
                  </Box>
                  <Box component="ul" sx={{ listStyle: 'none', m: 0, p: 0, display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                    {[
                      'Exposure on one of the UK\'s biggest property portals',
                      'Access to additional commercial tools and a broader property audience',
                      'A listing typically arranged through an estate agent',
                    ].map((text, i) => (
                      <Box
                        component="li"
                        key={i}
...
CommercialUKVsZooplaPage.getLayout = function getLayout(page: React.ReactElement) {
