...
import { Person as PersonIcon, Business as BusinessIcon, Home as HomeIcon } from '@mui/icons-material';
import { styled } from '@mui/material/styles';
import { useRouter } from 'next/router';
import { Page } from '../../../components';
import { UserDetailCard, BusinessDetailCard, UserPropertiesTable } from '../../../sections/admin/client-details';
...
const UserDetailPage: React.FC = () => {
  ...
  return (
    <Page title="User Detail - Commercial Real Estate">
      <Box>
        {/* Header */}
        <HeaderCard 
          title="User Detail"
          breadcrumbs={['Dashboard', 'Users', userData ? `${userData.firstName} ${userData.lastName}` : 'Loading...']}
          userData={userData}
        />
            ...
            <Box sx={{ 
                ...
                <Box sx={{
                  ...
                  {!loading && !error && (
                    userData?.business_details ? (
                      <BusinessDetailCard businessData={userData.business_details} />
                    ) : (
                      <Box sx={{
                        minHeight: '60vh',
                        display: 'flex',
              ...
              <CustomTabPanel value={tabValue} index={2}>
                <Box sx={{
                  ...
                  {!loading && !error && typeof id === 'string' && (
                    <UserPropertiesTable userId={id} />
                  )}
                </Box>
              </CustomTabPanel>
            </Box>
