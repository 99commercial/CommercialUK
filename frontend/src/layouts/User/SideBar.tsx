  ...
  const menuItems = [
    {
      section: 'GENERAL',
      items: [
        { id: 'dashboard' , path: '/user', label: 'Dashboard', icon: DashboardIcon },
      ],
    },
    {
      section: 'User',
      items: [
        { id: 'My Profile', path: '/user/account/my-profile', label: 'My Profile', icon: PersonIcon },
        { id: 'Edit Profile', path: '/user/account/my-account', label: 'Edit Profile', icon: EditIcon },
        { id: 'Edit Business Details', path: '/user/account/my-business-account', label: 'Edit Business Details', icon: BusinessIcon },
      ],
    },
    {
      section: 'Properties',
      items: [
        { id: 'Create New', path: '/user/property/create-property', label: 'Create New', icon: AddIcon },
        { id: 'My Properties' , path: '/user/property/my-properties', label: 'My Properties', icon: HomeIcon },
        { id: 'My Favourite Properties' , path: '/user/property/my-favourite-list', label: 'My Favourite Properties', icon: StarIcon },
      ],
    },
    {
      section: 'Queries',
      items: [
        { id: 'queries', path: '/user/queries/my-property-queries', label: 'All Queries', icon: QueryBuilderIcon },
        { id: 'My Queries' , path: '/user/queries/my-queries-raised', label: 'My Queries', icon: QuestionAnswerIcon },
      ],
    },
  ];
