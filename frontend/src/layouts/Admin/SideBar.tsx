  ...
  const menuItems = [
    {
      section: 'GENERAL',
      items: [
        { id: 'dashboard' , path: '/admin', label: 'Dashboard', icon: DashboardIcon },
      ],
    },
    {
      section: 'User',
      items: [
        { id: 'My Profile', path: '/admin/account/my-profile', label: 'My Profile', icon: AccountCircleIcon },
        { id: 'Edit Profile', path: '/admin/account/my-account', label: 'Edit Profile', icon: ManageAccountsIcon },
      ],
    },
    {
      section: 'Analytics',
      items: [
        { id: 'Agents', path: '/admin/dashboard/list-agent', label: 'Agents', icon: GroupIcon },
        { id: 'Users', path: '/admin/dashboard/list-user', label: 'Users', icon: PersonAddIcon },
        { id: 'Properties', path: '/admin/dashboard/properties', label: 'Properties', icon: HomeWorkIcon },
