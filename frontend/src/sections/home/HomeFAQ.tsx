...
const targetedReachFaqs = [
  ...
  },
  {
    ...
    answer:
      'When you remove a contact list, the system eliminates that information from current and upcoming campaigns. The list will no longer be utilised for targeting, and it can take up to 48 hours for it to be completely eliminated from the system',
    icon: <QuestionAnswerIcon />,
    category: 'Targeted Reach',
  },
];
...
const listingPromotionsFaqs = [
  ...
  {
    question: 'How do I manage and organise documents for my listings?',
    answer:
      'Go to Media & Documents across all listings. Organise folders for brochures, compliance, and legal documents. Upload documents and label them clearly. This keeps you professional and compliant',
    icon: <BusinessIcon />,
    category: 'Listing Promotions',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Become Premium Visibility. Use Targeted Email Campaigns. Broadcast your property on CommercialUK partner networks. These features maximise visibility',
    icon: <TrendingUpIcon />,
    category: 'Listing Promotions',
  },
  {
...
const investorDocumentHubFaqs = [
  ...
  {
    question: 'Can I create my own folders and organise documents my own way?',
    answer: 'Yes, you can set up custom folders and organise your Data Room to fit your workflow for the project, based on property type, due-diligence category, or however the team prefers',
    icon: <BusinessIcon />,
    category: 'Document Hub',
  },
  {
