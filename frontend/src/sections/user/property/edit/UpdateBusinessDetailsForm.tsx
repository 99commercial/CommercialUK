  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (changedSections.businessRates && initialData?.business_rates_id?._id) {
        requests.push({
          promise: axiosInstance.patch(`/api/user/business-rates/${initialData.business_rates_id._id}`, formData.business_rates),
      ...
      if (changedSections.descriptions && initialData?.descriptions_id?._id) {
        requests.push({
          promise: axiosInstance.patch(`/api/user/descriptions/${initialData.descriptions_id._id}`, formData.descriptions),
      ...
      if (changedSections.saleTypes && initialData?.sale_types_id?._id) {
        requests.push({
          promise: axiosInstance.patch(`/api/user/sale-types/${initialData.sale_types_id._id}`, { sale_types: formData.sale_types }),
          section: 'sale_types'
        });
      }
